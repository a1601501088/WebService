 ...
 * generated in the only.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _SaHiResponse_QNAME = new QName("http://ws.only/", "saHiResponse");
    private final static QName _SaHi_QNAME = new QName("http://ws.only/", "saHi");
    private final static QName _GetCatsByUser_QNAME = new QName("http://ws.only/", "getCatsByUser");
    private final static QName _GetAllCats_QNAME = new QName("http://ws.only/", "getAllCats");
    private final static QName _GetAllCatsResponse_QNAME = new QName("http://ws.only/", "getAllCatsResponse");
    private final static QName _GetCatsByUserResponse_QNAME = new QName("http://ws.only/", "getCatsByUserResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: only.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.only/", name = "saHiResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.only/", name = "saHi")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.only/", name = "getCatsByUser")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.only/", name = "getAllCats")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.only/", name = "getAllCatsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.only/", name = "getCatsByUserResponse")
